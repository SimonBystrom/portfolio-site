const projects = [
    {
    title: 'Split it',
    description: 'Final project (2 weeks) built during my time at Le Wagon bootcamp. Mobile first app to help couples or groups of friends split costs for larger events like trips or monthly expenses. Allows the user to scan a photo of a receipt and then automatically fills in the total and the name of the store. Automatically splits the total between all the members of the group and says who should pay whom and how much.',
    tech: ["devicon-rails-plain", "devicon-ruby-plain", "devicon-javascript-plain", "devicon-html5-plain", "devicon-sass-original", "devicon-googlecloud-plain", "devicon-heroku-original"],
